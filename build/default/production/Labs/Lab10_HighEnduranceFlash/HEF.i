...
# 1 "Labs/Lab10_HighEnduranceFlash/HEF.c"

# 183 "Labs/Lab10_HighEnduranceFlash/../../mcc_generated_files/pin_manager.h"
...
# 99 "Labs/Lab10_HighEnduranceFlash/../../mcc_generated_files/memory.h"
...
# 70 "Labs/Lab10_HighEnduranceFlash/../../labs.h"
uint8_t labNumber = 0;
...
# 63 "Labs/Lab10_HighEnduranceFlash/HEF.c"
...
FLASH_WriteWord(0x1F85, Buf, writeData);


rotateReg = FLASH_ReadWord(0x1F85);



LATAbits.LATA5 = rotateReg & 1;
LATAbits.LATA1 = (rotateReg & 2) >> 1;
LATAbits.LATA2 = (rotateReg & 4) >> 2;
LATCbits.LATC5 = (rotateReg & 8) >> 3;
}
